...
$q1='select * from tutorblog where tutorid = "'.$row['tutorid'].'"';
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Tutor Blog</h1>
          </div>
            ...
            <div class="col-xl-8 col-lg-7">
              ...
              <div class="card shadow mb-4" style="width: 650px;">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Blog Title: <?php echo $row1[2];?></h6>
                </div>
                <div class="card-body">
                  <p><?php echo $row1[3];?></p>
                  <p class="mb-0"><b>Posted Date:</b> <?php echo $row1[4];?></p>
                  <p class="mb-0"><b>Modified Date:</b> <?php echo $row1[5];?></p>
