...
{ 
  ...
  $mobile=$_POST['mobile'];
    ...
    { 
      ...
      { window.open('registeruser.php','_self');} else {window.open('registeruser.php','_self');}</script>";
    }
    else if($gender=="0"){
    ...
    { 
        ...
        { 
          ...
          $sql = "INSERT INTO user (Username,gender,age, Email, Password, Mobile ) VALUES ('$name2','$gender','$age', '$email2', '$password3', '$mobile2')";
