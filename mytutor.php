      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">My Tutor</h1>
          </div>
            ...
            <div class="col-xl-8 col-lg-7">
              <div style="width: max-content;">
                ...
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary"><?php echo $notutor;?></h6>
                  <h6 class="m-0 font-weight-bold text-primary">Name: <?php echo $row1[1];?></h6>
                </div>
                <div class="card-body">
                  <p class="mb-0"><b>Tutor ID:</b> <?php echo $row1[0];?></p>
                  <p class="mb-0"><b>Email:</b> <?php echo $row1[2];?></p>
                  <p class="mb-0"><b>Mobile:</b> <?php echo $row1[4];?></p>
