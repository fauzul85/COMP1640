...
$q='select * from meeting where fromid = "'.$_SESSION['userid'].'"';
...
if(
   isset($_POST['cancel']))
{ 
  $meetingid=$_POST['cancel'];

  // sql to delete a record
  $sql = 'DELETE from meeting where meetingid = "'.$meetingid.'"';

  if (mysqli_query($link, $sql)) {
    echo "<script type='text/javascript'>if(confirm('Meeting Canceled!')) 
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">List of Meetings</h1>
          </div>
            ...
            <div class="col-xl-8 col-lg-7">
              <div style="width: max-content;">
                ...
                <table class="table table-hover"  border="1" style="background-color: #f2f2f2;     font-size: 12px;" >
                    ...
                    <th>Meeting ID</th><th>Meeting With</th><th>Title</th><th>Description</th><th>Time</th><th>Type</th><th>Date</th><th>Cancel Meeting</th></tr>
                    ...
                    <tr>
                      ...
                      <form method="POST">
                      <td><button type="submit" name="cancel" value="<?php echo $row[0];?>"><font color="red">Cancel</font></button></td>
                      </form>
                    </tr>
