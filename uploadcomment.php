...
$q='select * from uploadcomment where uploadid = "'.$_GET['uploadid'].'"';
...
if(isset($_POST['submit']))
{
  ...
  $commentdate = date('Y-m-d');
          ...
          $sqladd = "INSERT INTO uploadcomment (uploadid, userid,comment, date ) VALUES ($uploadid, $userid,'$comment', '$commentdate')";
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Comment on Documents</h1>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-xl-8 col-lg-7">
              ...
              <form action="" method="POST">
                  ...
                  <div class="form-group">
                    <button name="submit" name="send" type="submit" value="<?php echo $uploadid;?>" class="btn btn-primary">SEND</button>
                  </div>
                </form>
