...
if(isset($_POST['submit'])){
  ...
  $messagedate = date('Y-m-d');
          ...
          $sqladd = "INSERT INTO messages (fromid, toid,toname, title, message,messagedate ) VALUES ($studentid, $tutorid,'$tutorname', '$title','$message','$messagedate')";
          if(mysqli_query($link, $sqladd)){
       
            echo "<script type='text/javascript'>if(confirm('Message send to $tutorname')) 
            { window.open('newmessage.php','_self');} else {window.open('newmessage.php','_self');}</script>";
              ...
              <div class="card shadow mb-4">
                ...
                <form action="" method="POST">
                  ...
                  <div class="form-group">
                    ...
                    <textarea id="message" name="message" cols="40" rows="5" class="form-control" required></textarea>
                  </div> 
                  <div class="form-group">
                    <button name="submit" name="send" type="submit" class="btn btn-primary">Send</button>
                  </div>
                </form>
