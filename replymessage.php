...
$q='select * from messages where messageid = "'.$_GET['messageid'].'"';
...
if (empty($row['0'])){
	...
	$q1='select * from tutor where tutorid = "'.$row['fromid'].'"';
...
if(isset($_POST['replybtn'])||
   isset($_POST['replytitle'])||
   isset($_POST['replytitle']))
{ 
  $replyto =  $_GET['messageid'];
  ...
  $replydate = date('Y-m-d');
          ...
          $sqladd = "INSERT INTO replymessages (replyto, title, message,replydate ) VALUES ($replyto, '$title','$message','$replydate')";
          if(mysqli_query($link, $sqladd)){
       
            echo "<script type='text/javascript'>if(confirm('Message Replied!')) 
            { window.open('receivemessage.php','_self');} else {window.open('receivemessage.php','_self');}</script>";
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="">My Blog</a>
            <a class="collapse-item" href="">Student Blog</a>
            <a class="collapse-item" href="">Tutor Blog</a>
          </div>
        </div>
      </li>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Reply Message</h1>
          </div>
              ...
              <div class="card shadow mb-4">
                ...
                <form>
                  ...
                  <div class="form-group">
                    <label for="tutor">Sender:</label> 
                    <input id="tutor" name="tutor" type="text" class="form-control" value="<?php echo ($tutorname) ?>" readonly>
                  </div>
                  <div class="form-group">
                    <label for="title">Message Title:</label> 
                    <input id="title" name="title" type="text" class="form-control" value="<?php echo $row['title'] ?>" readonly >
                  </div>
                  <div class="form-group">
                    <label for="message">Message:</label> 
                    <textarea id="message" name="message" cols="40" rows="5" class="form-control"   readonly><?php echo $row['message'] ?></textarea>
                  </div> 
                ...
                <form action="" method="POST">
                  ...
                  <div class="form-group">
                    <label for="title">Message Title:</label> 
                    <input id="title" name="replytitle" type="text" class="form-control" required >
                  </div>
                  <div class="form-group">
                    <label for="message">Message:</label> 
                    <textarea id="message" name="replymessage" cols="40" rows="5" class="form-control" required></textarea>
                  </div> 
                  <div class="form-group">
                    <button name="submit" name="replybtn" type="submit" class="btn btn-primary">Reply</button>
                  </div>
                </form>
