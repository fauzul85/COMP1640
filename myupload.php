...
if($_SESSION['loginas']=="tutor"){
  $q='select * from tutorupload where tutorid = "'.$_SESSION['userid'].'"';
}
if($_SESSION['loginas']=="student"){
  $q='select * from upload where studentid = "'.$_SESSION['userid'].'"';
}
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">My Upload</h1>
          </div>
            ...
            <div class="col-xl-8 col-lg-7">
              ...
              <div class="card shadow mb-4" style="width: 600px;">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Title: <?php echo $row[2];?></h6>
                </div>
                <div class="card-body">
                  <p>Description: <?php echo $row[3];?></p>
                  <p class="mb-0">Upload Date: <?php echo $row[7];?></p>
                  <div style="margin-top: 10px;">
                    <button id="submit" name="download"  onclick="download('<?php echo $row[6];?>')"  class="btn btn-primary">DOWNLOAD</button>
                   <button id="submit" name="comment" onclick="comment('<?php echo $row[0];?>')" class="btn btn-primary">COMMENT</button>
                   <form action="" method="POST" style="display: contents;">
                   <button id="submit" name="delete"  class="btn btn-primary" value="<?php echo $row[0];?>">DELETE</button>
                  </form>
                  </div>
                </div>
