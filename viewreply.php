...
$q='select * from replymessages where replyto = "'.$_GET['messageid'].'"';
...
$q1='select * from messages where messageid = "'.$messageId.'"';
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">View reply message for Message Title: <?php echo $row1[4];?></h1>
          </div>
            ...
            <div class="col-xl-8 col-lg-7">
              <div style="width: max-content;">
                ...
                <table class="table table-hover"  border="1" style="background-color: #f2f2f2;     font-size: 12px;" >
                    ...
                    <th>Reply ID</th><th>Title</th><th>Message</th><th>Date</th></tr>
                    ...
                    <tr>
                      ...
                      <td> <div  style="width: 300px;height: 30px;word-break: break-all;overflow-x: auto;">
                        <?php echo $row[3];?></td>
                          </div>
